...
public class ClasspathResourceLoader implements ResourceLoader {
     ...
     * 输出：
     * Resource(path=com/github/peacetrue/util, isDirectory=true)
     * Resource(path=com/github/peacetrue/util/ClasspathUtils.class, isDirectory=false)
     * Resource(path=com/github/peacetrue/util/Resource.class, isDirectory=false)
     * </pre>
     *
    ...
    public List<Resource> getResources(String location) throws IOException {
        ...
        while (resources.hasMoreElements()) {
            ...
            if (resourceAbsolutePath.startsWith("jar:"))
                resourceAbsolutePath = resourceAbsolutePath.substring("jar:".length());
            if (resourceAbsolutePath.startsWith("file:"))
                resourceAbsolutePath = resourceAbsolutePath.substring("file:".length());
